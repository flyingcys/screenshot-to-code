  ...
  return (
    <div className="flex w-full items-center justify-between border-b border-gray-200 bg-gray-50 px-2 py-2 dark:border-zinc-800 dark:bg-zinc-900 lg:h-full lg:w-16 lg:flex-col lg:items-center lg:gap-y-3 lg:border-b-0 lg:border-r lg:px-0 lg:py-4">
      ...
      <div className="flex items-center gap-1 lg:flex-col lg:gap-0 lg:contents">
        {showEditor && (
          ...
          >
            ...
            <span className="hidden text-[10px] leading-none lg:block">{t("common.editor")}</span>
          </button>
        )}
        ...
        {showHistory && (
          <button
            ...
            title={t("common.allVersions")}
          >
            <LuClock className="w-[18px] h-[18px]" />
            <span className="hidden text-[10px] leading-none lg:block">{t("common.allVersions")}</span>
          </button>
        )}
        ...
        >
          ...
          <span className="hidden text-[10px] leading-none lg:block font-medium">{t("common.newProject")}</span>
        </button>
      </div>
      ...
      >
        ...
        <span className="hidden text-[10px] leading-none lg:block">{t("common.settings")}</span>
      </button>
    </div>
  );
}
